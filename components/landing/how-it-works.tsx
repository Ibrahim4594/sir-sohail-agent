...
const STEPS: { n: string; heading: string; body: string }[] = [
  ...
  },
  {
    ...
    body: 'Sir Sohail Agent retrieves from the 52-paper corpus, grounds every claim in a passage, and streams the answer with footnote markers — nothing invented.',
  },
  {
    n: '03',
